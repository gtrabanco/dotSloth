...
| 12 | `skill-lockfile` | done | — | Package dump/import for agent skills (`bunx`/`npx` skills) with YAML lockfile and skills.sh integration · [#340](https://github.com/gtrabanco/dotSloth/pull/340) · [#330](https://github.com/gtrabanco/dotSloth/issues/330) | [#330](https://github.com/gtrabanco/dotSloth/issues/330) |
